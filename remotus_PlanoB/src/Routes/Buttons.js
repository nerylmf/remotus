...
export function Favorito() {
    ...
    const iconFavorito = `<svg width="20" height="18" viewBox="0 0 17 15" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M8.25642 15L7.07113 13.921C2.86132 10.1035 0.0820312 7.58583 0.0820312 4.49591C0.0820312 1.9782 2.06023 0 4.57794 0C6.00029 0 7.36541 0.662125 8.25642 1.70845C9.14743 0.662125 10.5125 0 11.9349 0C14.4526 0 16.4308 1.9782 16.4308 4.49591C16.4308 7.58583 13.6515 10.1035 9.4417 13.9292L8.25642 15Z" fill="#FFFFFF"/>
    </svg>       
    `;
    return (
        <View >
            {/* <Image source={require('../assets/Icon/Buttons/Favorito.svg')} style={styles.iconMedio} /> */}
            <SvgXml xml={iconFavorito}  style={{marginVertical:25}} />
        </View>
    )
}
...
export function IconLocalizaçãoVerde() {

    const localizacao = `<svg width="11" height="14" viewBox="0 0 7 10" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    return (
        <View >
            {/* <Image source={require('../assets/Icon/Buttons/Favorito.svg')} style={styles.iconMedio} /> */}
            <SvgXml xml={localizacao} />
        </View>
    )
}

export function IconLocalizacaoMarrom() {

    const localizacao = `<svg width="11" height="14" viewBox="0 0 7 10" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M3.5 0C1.565 0 0 1.565 0 3.5C0 6.125 3.5 10 3.5 10C3.5 10 7 6.125 7 3.5C7 1.565 5.435 0 3.5 0ZM3.5 4.75C2.81 4.75 2.25 4.19 2.25 3.5C2.25 2.81 2.81 2.25 3.5 2.25C4.19 2.25 4.75 2.81 4.75 3.5C4.75 4.19 4.19 4.75 3.5 4.75Z" fill="#A96B3C"/>
    </svg>     
    `;
    return (
        <View >
...
export function IconStarVerde() {

    const starVerde = `<svg width="14" height="13" viewBox="0 0 11 10" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M5.26316 8.03684L8.51579 10L7.65263 6.3L10.5263 3.81053L6.7421 3.48947L5.26316 0L3.78421 3.48947L0 3.81053L2.87368 6.3L2.01053 10L5.26316 8.03684Z" fill="#B0CB32"/>
    </svg>
    ...
    return (
        <View >
            {/* <Image source={require('../assets/Icon/Buttons/Favorito.svg')} style={styles.iconMedio} /> */}
            <SvgXml xml={starVerde} />
        </View>
    )
}

export function IconStarMarrom() {

    const star = `<svg width="15" height="14" viewBox="0 0 11 10" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export function IconStarMarromG() {
    ...
    return (
        <View >
            {/* <Image source={require('../assets/Icon/Buttons/Favorito.svg')} style={styles.iconMedio} /> */}
            <SvgXml xml={star} style={{marginTop:2}} />
        </View>
    )
}
...
export function IconPerfilImg() {

    const perfil = `<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export function IconProtecao() {

    const protecao = `<svg width="18" height="22" viewBox="0 0 18 22" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M9 0L0 4V10C0 15.55 3.84 20.74 9 22C14.16 20.74 18 15.55 18 10V4L9 0ZM9 10.99H16C15.47 15.11 12.72 18.78 9 19.93V11H2V5.3L9 2.19V10.99Z" fill="black"/>
    </svg>
    `
    return (
        <View >
...
export function IconSino() {

    const sino = `<svg width="16" height="20" viewBox="0 0 16 20" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M8 20C9.1 20 10 19.1 10 18H6C6 19.1 6.89 20 8 20ZM14 14V9C14 5.93 12.36 3.36 9.5 2.68V2C9.5 1.17 8.83 0.5 8 0.5C7.17 0.5 6.5 1.17 6.5 2V2.68C3.63 3.36 2 5.92 2 9V14L0 16V17H16V16L14 14Z" fill="black"/>
    </svg>
...
export function IconPersquisar() {

    const pesq = `<svg width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M13.541 12H12.751L12.471 11.73C13.451 10.59 14.041 9.11 14.041 7.5C14.041 3.91 11.131 1 7.54102 1C3.95102 1 1.04102 3.91 1.04102 7.5C1.04102 11.09 3.95102 14 7.54102 14C9.15102 14 10.631 13.41 11.771 12.43L12.041 12.71V13.5L17.041 18.49L18.531 17L13.541 12ZM7.54102 12C5.05102 12 3.04102 9.99 3.04102 7.5C3.04102 5.01 5.05102 3 7.54102 3C10.031 3 12.041 5.01 12.041 7.5C12.041 9.99 10.031 12 7.54102 12Z" fill="#0D1321"/>
    </svg>
    ...
    return (
        <View >
            {/* <Image source={require('../assets/Icon/Buttons/Favorito.svg')} style={styles.iconMedio} /> */}
            <SvgXml xml={pesq} style={styles.button} />
        </View>
    )
}
...
export function IconFavoritar() {
    const favoritarLinha = `
    <svg width="20" height="18" viewBox="0 0 17 15" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M7.32569 13.5512L7.32497 13.5506C5.21001 11.6327 3.49509 10.0766 2.3029 8.61907C1.11645 7.16852 0.5 5.87663 0.5 4.49591C0.5 2.25434 2.25434 0.5 4.49591 0.5C5.76686 0.5 6.9945 1.09409 7.79371 2.03262L8.17439 2.47965L8.55506 2.03262C9.35427 1.09409 10.5819 0.5 11.8529 0.5C14.0944 0.5 15.8488 2.25434 15.8488 4.49591C15.8488 5.87664 15.2323 7.16854 14.0458 8.62022C12.8545 10.0777 11.1414 11.6344 9.02881 13.5542L9.02448 13.5581L9.02341 13.5591L8.17566 14.325L7.32569 13.5512Z" stroke="#FFFFFF"/>
    </svg>
    ...
    return (
        <View style={
            ...
            {/* <Image source={require('../assets/Icon/Buttons/FavoritoLinha.svg')} style={styles.button} /> */}
            <SvgXml xml={favoritarLinha} style={{  marginVertical: 25,}}  />
...
export function IconFavoritarB() {
    const favoritarLinha = `
    <svg width="20" height="18" viewBox="0 0 17 15" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M7.32569 13.5512L7.32497 13.5506C5.21001 11.6327 3.49509 10.0766 2.3029 8.61907C1.11645 7.16852 0.5 5.87663 0.5 4.49591C0.5 2.25434 2.25434 0.5 4.49591 0.5C5.76686 0.5 6.9945 1.09409 7.79371 2.03262L8.17439 2.47965L8.55506 2.03262C9.35427 1.09409 10.5819 0.5 11.8529 0.5C14.0944 0.5 15.8488 2.25434 15.8488 4.49591C15.8488 5.87664 15.2323 7.16854 14.0458 8.62022C12.8545 10.0777 11.1414 11.6344 9.02881 13.5542L9.02448 13.5581L9.02341 13.5591L8.17566 14.325L7.32569 13.5512Z" stroke="#0D1321"/>
    </svg>
